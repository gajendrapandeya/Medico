...
public class DailyTipsFragment extends Fragment {
    ...
    private void getImages() {
        ...
        itemName.add("5 tips for health"); //1
        itemName.add("10 good habits to stay healthy");
        itemName.add("Super Foods");
        itemName.add("To be long Then do this yoga");
        itemName.add("Nine tips to stay healthy");
        itemName.add("20 formula to stay healthy");
        itemName.add("Follow these small tips if you want to stay fit");
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                showNotification("Team CoderMonks",value);
                //
